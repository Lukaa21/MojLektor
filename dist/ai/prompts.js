...
exports.buildPromptForService = exports.buildEditingPlusProofreadPrompt = exports.buildEditingPrompt = exports.buildProofreadPrompt = exports.USER_SOURCE_END = exports.USER_SOURCE_START = void 0;
...
exports.USER_SOURCE_START = "<<<ML_USER_SOURCE_START>>>";
exports.USER_SOURCE_END = "<<<ML_USER_SOURCE_END>>>";
const wrapUserSource = (content) => [
    ...
    "",
    exports.USER_SOURCE_START,
    content,
    exports.USER_SOURCE_END,
].join("\n");
const buildProofreadPrompt = (content, textType, language) => {
    return [
...
exports.buildProofreadPrompt = buildProofreadPrompt;
const buildEditingPrompt = (content, textType, language) => {
    return [
...
exports.buildEditingPrompt = buildEditingPrompt;
const buildEditingPlusProofreadPrompt = (content, textType, language) => {
    return [
...
exports.buildEditingPlusProofreadPrompt = buildEditingPlusProofreadPrompt;
const buildPromptForService = (serviceType, content, textType, language) => {
    switch (serviceType) {
        case models_1.ServiceType.LEKTURA:
            return (0, exports.buildEditingPrompt)(content, textType, language);
        case models_1.ServiceType.KOREKTURA:
            return (0, exports.buildProofreadPrompt)(content, textType, language);
        case models_1.ServiceType.BOTH:
            return (0, exports.buildEditingPlusProofreadPrompt)(content, textType, language);
        default:
            return (0, exports.buildEditingPrompt)(content, textType, language);
    }
};
exports.buildPromptForService = buildPromptForService;
