...
export const buildProofreadPrompt = (
  ...
  return [
    `ULOGA: Iskusni korektor za ${textType} tekst na jeziku: ${language}.`,
    "",
    "KOREKTURA OBUHVATA ISKLJUČIVO STIL I JASNOĆU — ništa više, ništa manje:",
    "",
    ...
    "Vrati isključivo finalni korigovani tekst, bez objašnjenja.",
    "",
...
export const buildEditingPrompt = (
  ...
  return [
    `ULOGA: Strogi lektor (jezička ispravnost-only) za ${textType} tekst na jeziku: ${language}.`,
    "",
    "LEKTURA OBUHVATA ISKLJUČIVO SLEDEĆE — ništa više, ništa manje:",
    "",
    ...
    "",
    "APSOLUTNA OGRANIČENJA — ne diraj nikad:",
    "- Stil, ton i formulacije rečenica — to je posao korekture.",
    ...
    "- Ako nisi 100% siguran da je izmena isključivo lektorska, ostavi original.",
    "",
    "KONTEKST:",
    "Tekst je deo šire celine. Vrati isključivo jezički ispravan tekst bez objašnjenja, komentara i metateksta.",
    "",
    wrapUserSource(content),
  ].join("\n");
};
